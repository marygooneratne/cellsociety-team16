...
subclasses will defer mostly in how they update as rules differ for different kinds of models. Cells have a Visualization.SquareCell object
...
* Visualization.SquareCell: the visual representation object of the cell
...
* cellViewList: an 2D arraylist of JavaFX nodes of Visualization.SquareCell objects corresponding to cells
####Classes:
